    ...
    var methods = {
        show: function(options) {
            var wrapper = document.createElement("div"),
                ...
                boxContentPadding = parseInt(boxContent.css("padding-left"), 10) + parseInt(boxContent.css("padding-right"), 10),
                boxContentWidth = boxContent.innerWidth(),
                boxContentHeight = boxContent.outerHeight(true),
                scrollDistance = window.scrollY,
                leftOffset = (windowWidth / 2) - (boxContentWidth / 2),
                topOffset = ((windowHeight / 2) + scrollDistance) - (boxContentHeight / 2);
            ...
            $(closeButton).css("margin-left", (boxContentWidth - boxContentPadding) + "px");
            
            $(closeButton).append("close dialog");

            $(closeButton).prependTo(boxContent);
            /*
